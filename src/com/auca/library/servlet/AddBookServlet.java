...
import java.sql.Date; // Import the java.sql.Date class
...
public class AddBookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DatabaseConnection.getConnection()) {
            // Convert the publication_date from String to java.sql.Date
            Date pubDate = Date.valueOf(publicationDate); // Assumes the format is 'yyyy-mm-dd'
            ...
            statement.setDate(3, pubDate);  // Set the publication date as a Date object
